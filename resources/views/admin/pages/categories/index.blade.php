...
@section('title', __('admin_label.pages.categories.title'))

@section('breadcrumb')
    {{renderBreadcrumb(__('admin_label.pages.categories.title'), [['name' => __('admin_label.pages.home.title'), 'link' => '/']])}}
@endsection
    ...
    <div class="row">
        <div class="col-md-6 col-lg-6">
            <button type="button" class="btn btn-success" id="btn-add-category">
                {{__('admin_label.pages.categories.index.btn_add')}}
            </button>
        </div>
    </div>
    <div class="row mt-2">
