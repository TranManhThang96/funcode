    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
            ...
            <ul class="navbar-nav float-right">
                ...
                <!-- Locale -->
                <!-- ============================================================== -->
                <div id="change-locale" class="nav-item dropdown d-flex align-items-center">
                    <a href="{{route('admin.locale')}}" class="btn locale text-white">
                        {{strtoupper(app()->getLocale() ?? session()->get('locale', config('app.locale')))}}
                    </a>
                </div>
